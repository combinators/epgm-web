...
import dao.{Database, EPGMDashboardDao, JedisDB, JedisDBMock}
import org.junit._
...
class EPGMDashboardDaoTest {
  ...
  def itShouldGetGradeDataFromDatabase(): Unit ={
    //given
    val sCode1 = "gradewise27"
    val sCode2 = "gradewise52"

    //when
    val stateRecord1 = EPGMDashboardDao[DB](sCode1).data
    val stateRecord2 = EPGMDashboardDao[DB](sCode2).data
  ...
  def itShouldGetGenderDataFromDatabase(): Unit ={
    //given
    val sCode1 = "genderwise27"
    val sCode2 = "genderwise52"
    //when
  ...
  def itShouldGetAgeDataFromDatabase(): Unit ={
    //given
    val sCode1 = "agewise27"
    val sCode2 = "agewise52"
    //when
  ...
  def itShouldGetMonthDataFromDatabase(): Unit ={
    //given
    val sCode1 = "monthwise27"
    val sCode2 = "monthwise52"
    //when
